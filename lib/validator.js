...
async function main() {
  ...
  bridgeRopsten.on(
    ...
    async (sender, receiver, value, timestamp, blockNumber) => {
      ...
      console.log('Listening for events after Lock on Ropsten...') 
    },
  )
  ...
  bridgeRinkeby.on(
    ...
    async (sender, receiver, value, timestamp, blockNumber) => {
      ...
      console.log('Listening for events after Unlock on Rinkeby...')
    },
  )
  ...
  bridgeRinkeby.on(
    ...
    async (sender, receiver, value, timestamp, blockNumber) => {
      ...
      await syncTxRopsten.wait()
      console.log('Listening for events after Lock on Rinkeby...')
    },
  )
  ...
  bridgeRopsten.on(
    ...
    async (sender, receiver, value, timestamp, blockNumber) => {
      ...
      await syncTxRinkeby.wait()
      console.log('Listening for events after Unlock on Ropsten...')
    },
  )
